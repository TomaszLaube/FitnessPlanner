        ...
        <div class="mt-4 ml-4 mr-4">
            <form:form method="post" class="padding-small text-center" modelAttribute="plan">
                <div class="row border-bottom border-3">
                    <div class="col"><h3 class="color-header text-uppercase">Edit Plan</h3></div>
                ...
                <form:hidden path="created" value="${plan.created}"/>
                <form:hidden path="user.id" value="${plan.user.id}"/>
            </form:form>
        </div>
    </div>
</div>
